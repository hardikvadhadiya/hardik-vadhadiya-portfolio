    ...
    >
      ...
      <div className="container-px relative grid lg:grid-cols-[1.1fr,0.9fr] gap-16 items-center">
        ...
        <div className="animate-fade-up">
          ...
          <div className="mt-12 grid grid-cols-2 sm:grid-cols-4 gap-4 pt-8 border-t border-ink-border/20">
            {stats.map((item) => (
              <div key={item.label} className="flex flex-col">
                <span className="font-display text-2xl sm:text-3xl font-bold text-mint-400 tracking-tight">
                  {item.value}
                </span>
                <span className="font-mono text-[10px] sm:text-[11px] text-paper-500 uppercase tracking-wider mt-1 leading-tight">
                  {item.label}
                </span>
              </div>
            ))}
        ...
        <div className="relative animate-fade-up [animation-delay:150ms]">
          <div className="relative mx-auto max-w-sm aspect-square flex items-center justify-center">
            ...
            <div className="relative z-10 w-[78%] aspect-square rounded-full overflow-hidden border border-mint-500/30 shadow-2xl">
              <img
            ...
            {/* floating code-tag badges */}
            <span className="absolute top-2 left-0 sm:-left-2 card w-11 h-11 flex items-center justify-center font-mono text-xs text-mint-400 animate-float [animation-delay:0.3s] cursor-pointer hover:border-mint-400 hover:shadow-[0_0_12px_rgba(79,227,194,0.5),inset_0_0_12px_rgba(79,227,194,0.2)] transition-all duration-300">
              {'</>'}
            </span>
            <span className="absolute top-16 right-0 sm:-right-3 card w-11 h-11 flex items-center justify-center font-mono text-xs text-mint-400 animate-float [animation-delay:0.9s] cursor-pointer hover:border-mint-400 hover:shadow-[0_0_12px_rgba(79,227,194,0.5),inset_0_0_12px_rgba(79,227,194,0.2)] transition-all duration-300">
              {'{ }'}
            </span>

            {/* floating terminal card */}
            <div className="absolute -bottom-10 -left-4 sm:-left-8 w-64 sm:w-72 card p-4 animate-float [animation-delay:1.2s] z-20 cursor-pointer hover:border-mint-400 hover:shadow-[0_0_12px_rgba(79,227,194,0.5),inset_0_0_12px_rgba(79,227,194,0.2)] transition-all duration-300">
            ...
            {profile.available && (
              <div className="absolute -top-4 -right-4 sm:right-2 flex items-center gap-2 card px-3 py-1.5 z-20 animate-float [animation-delay:0.6s] cursor-pointer hover:border-mint-400 hover:shadow-[0_0_12px_rgba(79,227,194,0.5),inset_0_0_12px_rgba(79,227,194,0.2)] transition-all duration-300">
                ...
                <span className="font-mono text-[11px] text-paper-300">Available for projects</span>
              </div>
            )}
          </div>
        </div>
